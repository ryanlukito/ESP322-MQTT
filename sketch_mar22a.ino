...
const char* ssid = "Yefta"; ///  wifi ssid 
const char* password = "xxxxxxxx";
const char* mqtt_server = "xxx.xx.xx.x";// mosquitto server url
...
void loop() {
  ...
  if (now - lastMsg > 2000) { //perintah publish data
    ...
    client.publish("/yefta_sensor/data", jsonString);

    Serial.println("Data Publisheed: ");
